...
export default function MobileActionBar() {
  return (
    <div
      className="animate-fade fixed inset-x-0 bottom-0 z-50 border-t border-border/80 bg-background/95 px-6 pt-3 pb-[calc(.75rem+env(safe-area-inset-bottom))] shadow-[0_-8px_24px_hsl(201_37%_18%/.08)] backdrop-blur-md lg:hidden"
    ...
    >
      <div className="mx-auto grid max-w-md grid-cols-2 gap-2">
        ...
        >
          <Phone className="size-5 shrink-0" /> Call office
        </a>
        <Link
        ...
        >
          <CalendarDays className="size-5 shrink-0" /> Appointment
        </Link>
      </div>
    </div>
  );
